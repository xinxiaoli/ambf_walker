...
#     plt.plot(p)
#
# trainer = TPGMMTrainer.TPGMMTrainer(hip, "/home/nathanielgoldfarb/catkin_ws/src/ambf_walker/config/hip2", 25, 0.01)
# trainer.train()
runner = TPGMMRunner.TPGMMRunner("/home/nathanielgoldfarb/catkin_ws/src/ambf_walker/config/hip2.pickle")
ddx = []
for i in xrange(runner.get_length()):
    x = runner.step()
    xx = runner.ddx[0]
    ddx.append(xx)
